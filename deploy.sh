...
# git push -f git@gitee.com:muyaCode/FrontEndLearnNotes.git main:gh-pages # 发布到Gitee
git push -f git@github.com:muyaCode/FrontEndLearnNotes.git main:gh-pages # 发布到GitHub
...
## 打印仓库和文档地址-格式化带颜色配置：https://www.shuzhiduo.com/A/D854N3mVzE/
