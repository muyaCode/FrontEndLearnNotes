import{_ as s,c as n,o as a,a4 as l}from"./chunks/framework.HaEZziQ1.js";const u=JSON.parse('{"title":"Node项目项目开发跨域问题 - Nginx配置","description":"","frontmatter":{},"headers":[],"relativePath":"Document/Node后端框架开发/Node项目开发跨域问题.md","filePath":"Document/Node后端框架开发/Node项目开发跨域问题.md","lastUpdated":1709668918000}'),p={name:"Document/Node后端框架开发/Node项目开发跨域问题.md"},F=l(`<h1 id="node项目项目开发跨域问题-nginx配置" tabindex="-1">Node项目项目开发跨域问题 - Nginx配置 <a class="header-anchor" href="#node项目项目开发跨域问题-nginx配置" aria-label="Permalink to &quot;Node项目项目开发跨域问题 - Nginx配置&quot;">​</a></h1><h2 id="前后端分离开发的项目存在跨域问题" tabindex="-1">前后端分离开发的项目存在跨域问题 <a class="header-anchor" href="#前后端分离开发的项目存在跨域问题" aria-label="Permalink to &quot;前后端分离开发的项目存在跨域问题&quot;">​</a></h2><h3 id="_1-什么是跨域" tabindex="-1">1.什么是跨域? <a class="header-anchor" href="#_1-什么是跨域" aria-label="Permalink to &quot;1.什么是跨域?&quot;">​</a></h3><p><a href="https://www.xxx.com:3000" target="_blank" rel="noreferrer">https://www.xxx.com:3000</a></p><p><a href="http://www.xxx.com:3000" target="_blank" rel="noreferrer">http://www.xxx.com:3000</a></p><p>协议/一级域名/二级域名/端口号 有一个不同就是跨域</p><p>由于3000端口和3001端口不同, 所以就是跨域</p><p>所以我们在3000端口设置的cookie3001是不能使用的，</p><p>而我们在3001端口设置的cookie3000也是不能使用的</p><h3 id="_2-cookie的跨域问题" tabindex="-1">2.Cookie的跨域问题 <a class="header-anchor" href="#_2-cookie的跨域问题" aria-label="Permalink to &quot;2.Cookie的跨域问题&quot;">​</a></h3><p>Cookie是不能跨域使用的, 所以在前后端分离开发的时候，我们当前的代码就会出现问题</p><p>例如:</p><p>前端地址: <a href="http://192.168.0.107:3001/login.html" target="_blank" rel="noreferrer">http://192.168.0.107:3001/login.html</a></p><p>后端地址: <a href="http://127.0.0.1:3000/api/user/testookie%E7%9A%84%E8%B7%A8%E5%9F%9F%E9%97%AE%E9%A2%98" target="_blank" rel="noreferrer">http://127.0.0.1:3000/api/user/testookie的跨域问题</a></p><p>Cookie是不能跨域使用的，所以在前后端分离开发的时候, 我们当前的代码就会出现问题</p><p>例如:</p><p>前端地址: <a href="http://192.168.0.107:3001/login.html" target="_blank" rel="noreferrer">http://192.168.0.107:3001/login.html</a></p><p>后端地址: <a href="http://127.0.0.1:3000/api/user/test" target="_blank" rel="noreferrer">http://127.0.0.1:3000/api/user/test</a></p><h3 id="正向代理和反向代理" tabindex="-1">正向代理和反向代理 <a class="header-anchor" href="#正向代理和反向代理" aria-label="Permalink to &quot;正向代理和反向代理&quot;">​</a></h3><h4 id="正向代理" tabindex="-1">正向代理 <a class="header-anchor" href="#正向代理" aria-label="Permalink to &quot;正向代理&quot;">​</a></h4><p>顺着请求的方向进行的代理, 我们称之为正向代理</p><p>例如: 访问谷歌</p><p>我是一个用户，我访问不了谷歌，但是我可以访问一台海外的服务器，这台海外服务器又可以访问谷歌</p><p>那么&#39;我&#39;就可以先访问&#39;海外的服务器&#39;, 再通过&#39;海外的服务器&#39;访问谷歌，这就是正向代理</p><h5 id="正向代理特点" tabindex="-1">正向代理特点 <a class="header-anchor" href="#正向代理特点" aria-label="Permalink to &quot;正向代理特点&quot;">​</a></h5><ul><li>在正向代理中，代理服务器是为用户服务的,</li></ul><p>(对于谷歌来说，它并不知道真正访问自己的是谁，只知道有一台服务器访问了自己)</p><h5 id="正向代理的用途" tabindex="-1">正向代理的用途 <a class="header-anchor" href="#正向代理的用途" aria-label="Permalink to &quot;正向代理的用途&quot;">​</a></h5><ul><li><p>访问原来无法访问的资源，如google</p></li><li><p>对客户端访问授权，上网进行认证</p></li><li><p>... ...</p></li></ul><h4 id="反向代理" tabindex="-1">反向代理 <a class="header-anchor" href="#反向代理" aria-label="Permalink to &quot;反向代理&quot;">​</a></h4><p>反向代理和正向代理正好相反，反向代理服务器是为&#39;服务器&#39;服务的</p><p>(对于用户来说，它并不知道自己真正访问的是谁,，只知道自己访问了一台服务器)</p><h5 id="反向代理的用途" tabindex="-1">反向代理的用途 <a class="header-anchor" href="#反向代理的用途" aria-label="Permalink to &quot;反向代理的用途&quot;">​</a></h5><ul><li><p>负载均衡，通过反向代理服务器来优化网站的负载</p></li><li><p>前后端分离, 统一请求地址</p></li></ul><h3 id="_3-如何解决前后端分离cookie的跨域问题" tabindex="-1">3.如何解决前后端分离Cookie的跨域问题? <a class="header-anchor" href="#_3-如何解决前后端分离cookie的跨域问题" aria-label="Permalink to &quot;3.如何解决前后端分离Cookie的跨域问题?&quot;">​</a></h3><h4 id="本地web服务器搭建" tabindex="-1">本地web服务器搭建 <a class="header-anchor" href="#本地web服务器搭建" aria-label="Permalink to &quot;本地web服务器搭建&quot;">​</a></h4><p>http-server本地服务器库，npm文档：<a href="https://www.npmjs.com/package/http-server" target="_blank" rel="noreferrer">http-server - npm (npmjs.com)</a></p><p>1.全局安装http-server库：</p><div class="language-bash line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki one-dark-pro vp-code"><code><span class="line"><span style="color:#61AFEF;">npm</span><span style="color:#98C379;"> install</span><span style="color:#D19A66;"> --global</span><span style="color:#98C379;"> http-server</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>2.在静态文件目录下打开终端，输入运行命令：<code>http-server -p 端口</code></p><div class="language-bash line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki one-dark-pro vp-code"><code><span class="line"><span style="color:#61AFEF;">http-server</span><span style="color:#D19A66;"> -p</span><span style="color:#D19A66;"> 3001</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>3.浏览器就可以访问静态文件了</p><div class="language-bash line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki one-dark-pro vp-code"><code><span class="line"><span style="color:#61AFEF;">localhost:3001</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>4.局域网其他机器访问</p><div class="language-bash line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki one-dark-pro vp-code"><code><span class="line"><span style="color:#61AFEF;">服务器机器的ip地址:端口</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br></div></div><h4 id="通过nginx反向代理配置解决跨域问题" tabindex="-1">通过Nginx反向代理配置解决跨域问题 <a class="header-anchor" href="#通过nginx反向代理配置解决跨域问题" aria-label="Permalink to &quot;通过Nginx反向代理配置解决跨域问题&quot;">​</a></h4><p>nginx具体配置文档：<a href="http://nginx.org/en/docs/" target="_blank" rel="noreferrer">nginx文档</a></p><p>1.Nginx下载：<a href="http://nginx.org/en/download.html" target="_blank" rel="noreferrer">nginx: download</a></p><p>2.下载后解压配置</p><ol><li><p>找到解压后的文件夹的目录：nginx/conf</p></li><li><p>编辑nginx.conf文件</p><ol><li><div class="language-bash line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki one-dark-pro vp-code"><code><span class="line"><span style="color:#7F848E;font-style:italic;"># 服务器CPU核数</span></span>
...
<span class="line"><span style="color:#61AFEF;">location</span><span style="color:#98C379;"> /</span><span style="color:#98C379;"> {</span><span style="color:#ABB2BF;">  </span></span>
...
<span class="line"><span style="color:#ABB2BF;">}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div></li></ol></li></ol><h4 id="nginx配置文件-nginx-conf-配置详解" tabindex="-1">Nginx配置文件 nginx.conf 配置详解 <a class="header-anchor" href="#nginx配置文件-nginx-conf-配置详解" aria-label="Permalink to &quot;Nginx配置文件 nginx.conf 配置详解&quot;">​</a></h4><div class="language-json line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki one-dark-pro vp-code"><code><span class="line"><span style="color:#ABB2BF;">#Nginx用户及组：用户 组。window下不指定</span></span>
...
<span class="line"><span style="color:#FFFFFF;">    #</span><span style="color:#FFFFFF;">   server</span><span style="color:#D19A66;">  192.168</span><span style="color:#FFFFFF;">.</span><span style="color:#D19A66;">247.129</span><span style="color:#FFFFFF;">:</span><span style="color:#D19A66;">8081</span><span style="color:#FFFFFF;"> max_fails=</span><span style="color:#D19A66;">3</span><span style="color:#FFFFFF;"> weight=</span><span style="color:#D19A66;">4</span><span style="color:#FFFFFF;">;</span><span style="color:#ABB2BF;">    </span></span>
...
<span class="line"><span style="color:#FFFFFF;">    #</span><span style="color:#FFFFFF;">       #proxy_temp_file_write_size</span><span style="color:#D19A66;"> 64</span><span style="color:#FFFFFF;">k;</span><span style="color:#FFFFFF;">   #设定缓存文件夹大小，大于这个值，将从upstream服务器传</span><span style="color:#ABB2BF;">     </span></span>
<span class="line"><span style="color:#FFFFFF;">    #</span><span style="color:#ABB2BF;">        </span></span>
...
<span class="line"><span style="color:#FFFFFF;">            try_files</span><span style="color:#FFFFFF;"> $uri</span><span style="color:#FFFFFF;"> $uri/</span><span style="color:#FFFFFF;"> /index.html;</span><span style="color:#ABB2BF;">    </span></span>
<span class="line"></span>
<span class="line"></span>
<span class="line"></span>
