...
1. JS Entry，子应用将资源打成一个 `entry script`，比如 `single-spa` 的 [example](https://link.juejin.cn?target=https%3A%2F%2Flink.segmentfault.com%2F%3Fenc%3DV4vNM3PeC4viRHYRWP0bOQ%3D%3D.q376bO8a%2BVDc%2B%2B3aXYvI4g3QjX4S%2BbJcQFFrrysYe4540Kwf2XS2eZSa5aH5Ixb%2F2kQXkLg5Ae2ceUjfO7X5gPPw8b1cKWFGmGp1zmuIbT%2Bzm68EV3zfcWxTjXxdENJipfI1Hsaue4rOp4UosAkjJeJsPB0o2K9lsY00Gj0uWdX%2F%2BnGueUR9hUKj5%2BqECSo2tn7LMGuA%2BH1u1tTBEVcv2Q%3D%3D) 中的方式。但这个方案的限制也颇多，如要求子应用的所有资源打包到一个 `js bundle` 里，包括 `css`、图片等资源。除了打出来的包可能体积庞大之外的问题之外，资源的并行加载等特性也无法利用上。
