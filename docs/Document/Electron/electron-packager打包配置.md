# electron-packager打包配置

### electron-packager：https://github.com/electron/electron-packager

### electron-packager配置文档：[npm.im/electron-packager](https://npm.im/electron-packager "https://npm.im/electron-packager")
...
##### 1、安装electron-packager npm install electron-packager --save-dev
