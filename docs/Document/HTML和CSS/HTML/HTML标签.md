...
:::  tip
为了更好地处理今天的互联网应用，HTML5添加了很多新元素及功能，比如： 图形的绘制，多媒体内容，更好的页面结构，更好的形式 处理，和几个api拖放元素，定位，包括网页 应用程序缓存，存储，网络工作者，等等。
:::
...
JavaScript方法文档-用于自定义播放器：[HTML 音频/视频 | 菜鸟教程 (runoob.com)](https://www.runoob.com/tags/ref-av-dom.html)
...
- [HTML5 地理定位_w3cschool](https://www.w3cschool.cn/html5/html5-geolocation.html)
