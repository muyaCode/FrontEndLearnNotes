...
- [JSX](https://links.jianshu.com/go?to=https%3A%2F%2Ffacebook.github.io%2Fjsx%2F)
- [Angular](https://links.jianshu.com/go?to=https%3A%2F%2Fangular.io%2F)
- [Vue](https://links.jianshu.com/go?to=https%3A%2F%2Fvuejs.org%2F)
- [Flow](https://links.jianshu.com/go?to=https%3A%2F%2Fflow.org%2F)
- [TypeScript](https://links.jianshu.com/go?to=https%3A%2F%2Fwww.typescriptlang.org%2F)
- CSS, [Less](https://links.jianshu.com/go?to=http%3A%2F%2Flesscss.org%2F), and [SCSS](https://links.jianshu.com/go?to=https%3A%2F%2Fsass-lang.com%2F)
- [HTML](https://links.jianshu.com/go?to=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FHTML)
- [JSON](https://links.jianshu.com/go?to=https%3A%2F%2Fjson.org%2F)
- [GraphQL](https://links.jianshu.com/go?to=https%3A%2F%2Fgraphql.org%2F)
- [Markdown](https://links.jianshu.com/go?to=https%3A%2F%2Fcommonmark.org%2F), including [GFM](https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.github.com%2Fgfm%2F) and [MDX](https://links.jianshu.com/go?to=https%3A%2F%2Fmdxjs.com%2F)
- [YAML](https://links.jianshu.com/go?to=https%3A%2F%2Fyaml.org%2F)
...
在项目根目录中新建perttier的默认配置文件，能够写入YML、JSON的配置格式，并且支持.yaml/.yml/.json/.js后缀，也可以不带后缀；： `.prettierrc` 文件，写入配置：
...
1. 三种打开设置方式：
   ...
   - 快捷键 `ctrl+shift+p` ，然后搜索：Settings -> 选择 -> 首选项：打开设置 -> 搜索Prettier - > 可以找到并点击 <u>在 settings.json 中编辑</u>
...
> Prettierc配置可以配合VSCode编辑器的保存时格式化代码使用：和上面 `编辑器全局配置设置` 步骤，最后一步搜索save - >勾选 `Editor: Format On Save`

下面的VSCode的setting.json配置是我自己的对于HTML/CSS/JS/LESS文件的prettier格式化规则：
...
需要安装[husky](https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2Ftypicode%2Fhusky) 和 [lint-staged](https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2Fokonet%2Flint-staged)这两个依赖才能实现，其中husky是帮助我们添加git hooks的工具，而lint-staged则是筛选那些staged的git文件执行lint。
...
prettier支持的配置文件的优先级如下，它使用 [cosmiconfig](https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2Fdavidtheclark%2Fcosmiconfig)提供配置文件支持的：
...
- semi,行末是否加分号，有以下几个原因让我选择false
  ...
  1. 我主要使用的vue他的代码风格就是不加分号的，不加分号代码也能正常运行(因为编译器是自动给你加分号执行的)，只需要注意几个会出问题的点。
