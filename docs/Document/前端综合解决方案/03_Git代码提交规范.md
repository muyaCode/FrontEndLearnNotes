...
#### **4.1 - gitmoji-cli**：git commit的表情工具
...
##### 1.VSCode编辑器插件：可在VSCode插件市场搜索安装

<mark>`gitlens`：git功能增强插件</mark>

vscode有自带git的功能，但是gitlens插件更多功能且比较强大
...
打开资源管理器，右击要查看的文件，选择GIt:View File History，即可查看修改历史。
...
打开git源代码管理，点击存储库的git图标，即可查看该git存储库的git log历史。
...
##### 2.WebStorm插件：[Git Commit Message Helper](https://links.jianshu.com/go?to=https%3A%2F%2Fplugins.jetbrains.com%2Fplugin%2F13477-git-commit-message-helper%2F)
