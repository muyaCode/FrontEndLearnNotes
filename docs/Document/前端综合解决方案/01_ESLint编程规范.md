...
配置选项：[List of available rules - ESLint中文](https://cn.eslint.org/docs/rules/)

## 什么是ESLint？

ESLint是一个用来识别ECMAScript/JavaScript并且按照规则给出报告的代码检测工具，他就是一个插件化的javascript代码检测**工具**。
...
[Getting Started with ESLint - ESLint中文](https://cn.eslint.org/docs/user-guide/getting-started)
...
- `process` — 处理器：希望利用 Eslint 来约束我们的 框架 代码(比如vue/react框架)，配合plugins使用：[Plugins - ESLint - Pluggable JavaScript Linter](https://eslint.org/docs/latest/user-guide/configuring/plugins#specifying-processor)
...
**插件开发文档：[使用插件 - ESLint - 最新文档](https://eslint.org/docs/latest/developer-guide/working-with-plugins)、[Working with Plugins - ESLint中文文档](https://cn.eslint.org/docs/developer-guide/working-with-plugins)**
