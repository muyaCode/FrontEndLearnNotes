...
### app.js中，请求先判断是否静态资源：staticServer.readFile(req, res, rootPath)，再设置其他请求响应数据处理
...
ejs的npm文档：[ejs - npm (npmjs.com)](https://www.npmjs.com/package/ejs)

### 加载ejs模板引擎，文件：dynamicServer.js
...
### 使用ejs模板编写html：views\index.html
