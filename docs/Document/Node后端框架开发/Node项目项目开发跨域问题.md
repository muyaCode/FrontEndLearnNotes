...
而我们在3001端口设置的cookie3000也是不能使用的
...
http-server本地服务器库，npm文档：[http-server - npm (npmjs.com)](https://www.npmjs.com/package/http-server)
...
nginx具体配置文档：[nginx文档](http://nginx.org/en/docs/)

1.Nginx下载：[nginx: download](http://nginx.org/en/download.html)
