...
官网告诉我们，ESLint是一个用来识别ECMAScript/JavaScript并且按照规则给出报告的代码检测工具，他就是一个插件化的javascript代码检测**工具**。
...
#### **ESLint的(用户指南)安装和配置：[Getting Started with ESLint - ESLint中文](https://cn.eslint.org/docs/user-guide/getting-started)**
