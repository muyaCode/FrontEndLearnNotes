  ...
  "/": [
    ...
    },
    {
      ...
      items: [
        ...
        {
          text: "Chrome浏览器插件",
          link: "/Document/前端开发环境配置/Chrome浏览器插件",
        },
        {
          text: "前端开发工具和网站",
          link: "/Document/前端开发环境配置/前端开发工具和网站",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          items:[
            ...
            {
              text: "SVG学习",
              link: "/Document/HTML和CSS/HTML/SVG学习",
            },
            {
              text: "移动端开发设置",
              link: "/Document/HTML和CSS/HTML/移动端开发设置",
            },
          ]
        },
        {
          ...
          items: [
            ...
            {
              text: "CSS练习",
              link: "/Document/HTML和CSS/CSS/CSS练习",
            },
            {
              text: "CSS新特性",
            ...
            {
              text: "CSS常见错误",
              link: "/Document/HTML和CSS/CSS/CSS常见错误",
            },
            {
              text: "CSS画图例子",
              link: "/Document/HTML和CSS/CSS/CSS画图例子",
            },
            {
              text: "CSS工程化(模块化)方案",
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: "ECMAScript-15(ES2024)",
              link: "/Document/JavaScript笔记/ECMAScript语法/ECMAScript-15(ES2024)",
            },
            {
              text: "ES6+代码开发技巧",
              link: "/Document/JavaScript笔记/ECMAScript语法/ES6+代码开发技巧",
            },
          ]
        },
        {
        ...
        {
          text: "JavaScript引擎",
          link: "/Document/JavaScript笔记/JavaScript引擎",
        },
        {
          text: "JavaScript代码技巧",
          link: "/Document/JavaScript笔记/JavaScript代码技巧",
        },
        {
          text: "JavaScript代码整洁之道",
          link: "/Document/JavaScript笔记/JavaScript代码整洁之道",
        },
        {
          text: "JavaScript工具方法",
          link: "/Document/JavaScript笔记/JavaScript工具方法",
        },
        {
          text: "JavaScript开发的领域",
          link: "/Document/JavaScript笔记/JavaScript开发的领域",
        },
        {
          text: "JavaScript学习工具网站",
          link: "/Document/JavaScript笔记/JavaScript学习工具网站",
        },
      ]
    },
    {
      ...
      items: [
        {
          text: "前端学习书籍推荐",
          link: "/Document/前端学习书籍推荐/前端学习书籍推荐",
        }
      ]
    },
    {
    ...
    },
    {
      ...
      items: [
        {
          text: "JSDoc简介",
          link: "/Document/JSDoc/JSDoc简介"
        },
        {
          text: "JSDoc入门",
          link: "/Document/JSDoc/JSDoc入门"
        },
      ]
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        {
          text: "计算机组成原理",
          link: "/Document/计算机基础/计算机组成原理"
        },
        {
          text: "计算机网络知识",
          link: "/Document/计算机基础/计算机网络知识"
        },
        {
          text: "操作系统知识",
          link: "/Document/计算机基础/操作系统知识"
        },
        {
          text: "浏览器原理和引擎",
          link: "/Document/计算机基础/浏览器原理和引擎"
        },
        {
          text: "数据结构和算法",
          link: "/Document/计算机基础/数据结构和算法"
        },
        {
          text: "设计模式",
          link: "/Document/计算机基础/设计模式"
        },
      ]
    },
    {
    ...
    {
      text: "前端工程师框架",
      link: "/Document/前端主流开发框架/前端工程师框架",
    },
    {
      text: "Vue学习",
      collapsible: true, // 可折叠
      ...
      items: [
        ...
        {
          text: "谷歌浏览器开发者工具使用教程",
          link: "/Document/前端主流开发框架/Vue/谷歌浏览器开发者工具使用教程",
        },
        {
          text: "uni-app开发",
          link: "/Document/前端主流开发框架/Vue/uni-app开发",
        },
        {
          text: "Vue开发库",
          collapsible: true,
          ...
          items: [
            ...
            {
              text: "alovajs",
              link: "/Document/前端主流开发框架/Vue/Vue开发库/alovajs",
            },
            {
              text: "tailwindcss",
        ...
        },
        {
          ...
          items: [
            {
              text: "Vue服务端渲染导学",
              link: "/Document/前端主流开发框架/Vue/Vue服务端渲染/Vue服务端渲染导学",
            },
            {
              text: "Vue+Nuxt服务端渲染",
        ...
        
        {
          ...
          items: [
            ...
            {
              text: "Vue3的组件通信方式",
              link: "/Document/前端主流开发框架/Vue/Vue3前端综合解决方案/Vue3的组件通信方式",
            },
            {
            ...
            {
              text: "Vue3使用JSX开发",
              link: "/Document/前端主流开发框架/Vue/Vue3前端综合解决方案/Vue3使用JSX开发",
            },
          ],
        },
        {
        ...
        
        {
          ...
          items: [
            {
              text: "Vue2和Vue3开发组件的区别",
              link: "/Document/前端主流开发框架/Vue/Vue2和Vue3对比/Vue2和Vue3开发组件的区别",
            },
            {
              text: "Vue.js3响应式API比2.x好在哪儿？",
              link: "/Document/前端主流开发框架/Vue/Vue2和Vue3对比/Vue.js3响应式API比2.x好在哪儿？",
            },
            {
              text: "",
              link: "/Document/前端主流开发框架/Vue/Vue2和Vue3对比/",
            },
            {
              text: "",
              link: "/Document/前端主流开发框架/Vue/Vue2和Vue3对比/",
    ...
    },
    {
      ...
      items: [
        ...
        {
          text: "React框架",
          link: "/Document/前端主流开发框架/React/React框架",
        },
        {
          text: "Dva数据流方案",
        ...
        },
        {
          ...
          items: [
            {
              text: "React原理",
              link: "/Document/前端主流开发框架/React/React全家桶源码解析/React原理",
            },
            {
              text: "React源码解析",
        ...
        {
          text: "ReactNative学习",
          link: "/Document/前端主流开发框架/React/ReactNative学习",
        },
        {
          text: "Next.js学习",
          link: "/Document/前端主流开发框架/React/Next.js学习",
        },
      ]
    },
    {
      text: "为什么React比Vue难",
      link: "/Document/前端主流开发框架/为什么React比Vue难",
    },
    {
      text: "😪Svelte学习",
      collapsible: true, // 可折叠
    ...
    },
    {
      ...
      items: [
        {
          text: "Alpine简介和相关网站",
          link: "/Document/前端主流开发框架/Alpine/Alpine简介和相关网站",
        },
      ]
    },
    {
      ...
      items: [
        {
          text: "Qwik简介和相关网站",
          link: "/Document/前端主流开发框架/Qwik/Qwik简介和相关网站",
        },
      ]
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        {
          text: "利用网页版微信API做一个微信机器人",
          link: "/Document/微信开发/利用网页版微信API做一个微信机器人",
        },
      ]
    },
    {
      ...
      items: [
        ...
        {
          text: "跨平台方案、跨端引擎的本质",
          link: "/Document/跨平台桌面端开发/跨平台方案、跨端引擎的本质",
        },
        {
          text: "Github Actions全平台应用打包",
          link: "/Document/跨平台桌面端开发/Github Actions全平台应用打包",
        },
        {
          text: "😗Electron笔记",
          collapsible: true, // 可折叠
          ...
          items: [
            ...
            {
              text: "Electron实现命令行终端工具",
              link: "/Document/跨平台桌面端开发/Electron/Electron实现命令行终端工具",
            },
            {
              text: "Electron相关库",
              link: "/Document/跨平台桌面端开发/Electron/Electron相关库",
            },
            {
              text: "Electron开发踩坑",
            ...
            {
              text: "Electron开源项目",
              link: "/Document/跨平台桌面端开发/Electron/Electron开源项目",
            },
          ]
        },
        {
          ...
          items: [
            ...
            {
              text: "Python与Tauri结合构建应用",
              link: "/Document/跨平台桌面端开发/Tauri框架/Python与Tauri结合构建应用",
            },
            {
              text: "Tauri原理",
              link: "/Document/跨平台桌面端开发/Tauri框架/Tauri原理",
            },
            {
              text: "Tauri实战",
              link: "/Document/跨平台桌面端开发/Tauri框架/Tauri实战",
            },
            {
              text: "",
              link: "/Document/跨平台桌面端开发/Tauri框架/",
            },
            {
              text: "Tauri插件安装与踩坑",
            ...
            {
              text: "Tauri2移动端开发和打包",
              link: "/Document/跨平台桌面端开发/Tauri框架/Tauri2移动端开发和打包",
            },
            {
              text: "Tauri打包遇见问题及解决",
            ...
            {
              text: "Tauri应用更新Updater",
              link: "/Document/跨平台桌面端开发/Tauri框架/Tauri应用更新Updater",
            },
            {
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: "Flutter框架和库",
              link: "/Document/移动端软件开发/Flutter框架/Flutter框架和库",
            },
            {
              text: "Flutter遇见问题及解决",
    ...
    {
      text: "前端开发生态库",
      link: "/Document/前端主流开发框架/前端开发生态库",
    },
    {
      text: "😏前端综合解决方案",
      collapsible: true, // 可折叠
      ...
      items: [
        ...
        {
          text: "低代码和无代码平台",
          link: "/Document/前端综合解决方案/低代码和无代码平台",
        },
        {
          text: "渐进式Web应用程序（PWA）",
          link: "/Document/前端综合解决方案/渐进式Web应用程序（PWA）",
        },
        {
          text: "跨平台应用程序开发",
          link: "/Document/前端综合解决方案/跨平台应用程序开发",
        },
        {
          text: "纯CSS图标",
      ...
      items: [
        {
          ...
          items: [
            {
              text: "Three.js学习资源和相关网站",
              link: "/Document/前端库学习/Three.js/Three.js学习资源和相关网站",
            },
            {
              text: "Three.js案例教程",
              link: "/Document/前端库学习/Three.js/Three.js案例教程",
            },
            {
              text: "",
              link: "/Document/前端库学习/Three.js/",
            },
            {
              text: "",
              link: "/Document/前端库学习/Three.js/",
    ...
    },
    {
      ...
      items: [
        {
          text: "工程化发展",
          link: "/Document/Project-Engineering/工程化发展",
        },
        {
          text: "前端工程化",
          collapsible: true,
    ...
    
    {
      ...
      items: [
        ...
        {
          text: "GitHub个人主页配置",
          link: "/Document/GitHub的使用/GitHub个人主页配置",
        },
        {
    ...
    },
    {
      ...
      items: [
        {
          text: "Chrome插件开发入门",
          link: "/Document/浏览器插件开发/Chrome插件开发入门",
        },
        {
          text: "TamperMonkey油猴插件开发",
          link: "/Document/浏览器插件开发/TamperMonkey油猴插件开发",
        },
        {
          text: "",
          link: "/Document/浏览器插件开发/",
        },
      ]
    },
    {
      ...
      items: [
        {
          text: "VSCode插件开发相关资源",
          link: "/Document/VSCode插件开发/VSCode插件开发相关资源",
        },
        {
          text: "VSCode插件开发教程",
          link: "/Document/VSCode插件开发/VSCode插件开发教程",
        },
        {
          text: "开源VSCode插件",
          link: "/Document/VSCode插件开发/开源VSCode插件",
        },
        {
          text: "",
          link: "/Document/VSCode插件开发/",
        },
        {
          text: "",
          link: "/Document/VSCode插件开发/",
    ...
    },
    {
      ...
      items: [
        ...
        {
          text: "开源Shell脚本项目",
          link: "/Document/Shell和Bat脚本语言和批处理/开源Shell脚本项目",
        },
      ]
    },
    
    {
      ...
      items: [
        ...
        {
          text: "Nuxt-DevTools",
          link: "/Document/DevDebug/Nuxt-DevTools",
        },
        {
          text: "React开发调试",
        ...
        {
          text: "代码编辑器调试",
          link: "/Document/DevDebug/代码编辑器调试",
        },
        {
          text: "其他调试工具",
        ...
        {
          text: "在线代码编辑器",
          link: "/Document/DevDebug/在线代码编辑器",
        },
      ]
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: "JavaScript其他WebAPI",
              link: "/Document/前端进阶技巧/综合能力提升/JavaScript其他WebAPI",
            },
            {
              text: "web端实现远程桌面控制",
              link: "/Document/前端进阶技巧/综合能力提升/web端实现远程桌面控制",
            },
            {
              text: "客户端与服务端实时通信方案",
              link: "/Document/前端进阶技巧/综合能力提升/客户端与服务端实时通信方案",
            },
            {
              text: "WebAPI",
              link: "/Document/前端进阶技巧/综合能力提升/WebAPI",
            },
            {
              text: "WebGL",
              link: "/Document/前端进阶技巧/综合能力提升/WebGL",
            },
            {
              text: "WebGPU",
              link: "/Document/前端进阶技巧/综合能力提升/WebGPU",
            },
            {
              text: "WebRTC",
              link: "/Document/前端进阶技巧/综合能力提升/WebRTC",
            },
            {
              text: "WebCodecs",
              link: "/Document/前端进阶技巧/综合能力提升/WebCodecs",
            },
            {
              text: "WebSocket",
              link: "/Document/前端进阶技巧/综合能力提升/WebSocket",
            },
            {
              text: "",
              link: "/Document/前端进阶技巧/综合能力提升/",
            },
          ]
        },
        {
          text: "前端开源学习项目",
          link: "/Document/前端进阶技巧/前端开源学习项目",
        },
        {
          text: "前端周刊",
          link: "/Document/前端进阶技巧/前端周刊",
        },
      ]
    },
    ...
    },
    {
      ...
      items: [
        ...
        {
          text: "Node脚本开发",
          link: "/Document/Node/Node脚本开发",
        },
        {
          text: "后端开发概念",
          link: "/Document/Node/后端开发概念",
        },
        {
          text: "插件、库、框架的概念",
          link: "/Document/Node/插件、库、框架的概念",
        },
        {
          text: "Node和其他语言集成",
    ...
    },
    {
      ...
      items: [
        {
          text: '后端开发概念',
          link: "/Document/Node后端框架开发/后端开发概念",
        },
        {
          text: "Node实战",
          collapsible: true,
          ...
          items: [
            {
              text: 'Node搭建Web服务器',
              link: "/Document/Node后端框架开发/Node实战/Node搭建Web服务器",
            },
            {
              text: 'Node+ffmpeg写一个视频服务器',
              link: "/Document/Node后端框架开发/Node实战/Node搭Node+ffmpeg写一个视频服务器建Web服务器",
            },
            {
              text: 'Node原生API服务开发',
              link: "/Document/Node后端框架开发/Node实战/Node原生API服务开发",
            },
            {
              text: 'Node连接操作MongoDB数据库',
              link: "/Document/Node后端框架开发/Node实战/Node连接操作MongoDB数据库",
            },
            {
              text: 'NodeJS爬虫系统开发',
              link: "/Document/Node后端框架开发/Node实战/NodeJS爬虫系统开发",
            },
            {
              text: 'Node开发终端工具',
              link: "/Document/Node后端框架开发/Node实战/Node开发终端工具",
            },
          ],
        },
        {
          text: "Node后端框架",
          link: "/Document/Node后端框架开发/Node后端框架",
        },
        {
          text: "Express框架",
          collapsible: true,
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: "Koa-链接(Links)",
              link: "/Document/Node后端框架开发/Koa框架/Koa-链接(Links)",
            },
            {
              text: "Koa-服务器(Bwh)",
              link: "/Document/Node后端框架开发/Koa框架/Koa-服务器(Bwh)",
            },
            {
              text: "Koa相关资源",
        ...
        {
          text: "hono框架",
          link: "/Document/Node后端框架开发/hono框架",
        },
        {
          text: "Strapi无头内容管理系统",
          link: "/Document/Node后端框架开发/Strapi无头内容管理系统",
        },
        {
          text: "ORM框架",
          link: "/Document/Node后端框架开发/ORM框架",
        },
        {
          text: "接口测试工具",
    ...
    },
    {
      ...
      items: [
        ...
        {
          text: "AssemblyScript",
          link: "/Document/WebAssembly/AssemblyScript",
        },
        {
          text: "MoonBit语言",
          link: "/Document/WebAssembly/MoonBit语言",
        },
        {
          text: "Rust与WebAssembly",
          link: "/Document/WebAssembly/Rust与WebAssembly",
        },
        {
          text: "C-C++与WebAssembly",
          link: "/Document/WebAssembly/C-C++与WebAssembly",
        },
        {
          text: "Python与WebAssembly",
          link: "/Document/WebAssembly/Python与WebAssembly",
        },
        {
          text: "Go与WebAssembly",
          link: "/Document/WebAssembly/Go与WebAssembly",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          items: [
            ...
            {
              text: "VitePress打造导航网站",
              link: "/Document/搭建在线博客或文档网站/VitePress和VuePress搭建在线博客或文档/VitePress打造导航网站",
            },
            {
              text: "脑洞例子",
        ...
        {
          text: "GitHub的issue博客框架Gmeek",
          link: "/Document/搭建在线博客或文档网站/GitHub的issue博客框架Gmeek",
        },
        {
          text: "基于Rust的MD编译器—Rspress",
          link: "/Document/搭建在线博客或文档网站/基于Rust的MD编译器—Rspress",
        },
        {
          text: "部署博客",
          link: "/Document/搭建在线博客或文档网站/部署博客",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        {
          text: "GitHub Actions教程",
          link: "/Document/开源相关/GitHub Actions教程",
        },
      ]
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            {
              text: "",
              link: "/Document/框架源码原理实现解析/React及依赖库源码解析/",
            },
            {
              text: "",
              link: "/Document/框架源码原理实现解析/React及依赖库源码解析/",
